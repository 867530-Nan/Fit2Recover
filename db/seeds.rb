...
Testimonial.create!([
	...
	subject: '',
	body: "This is an amazing organization and I am honored to be a part of it. It's not just a gym, its a community, focused on helping others, in and outside of the gym. I am a member and attend fitness classes here 5-6 days a week. I had a lot of reservations about attending my 1st class and was amazed with experience I had, everyone was so friendly and helpful. I have made dear relationships with members and staff at this gym. Their example and support have helped me become a better person, mentally, physically and spiritually. They offer writing classes, art classes, rock climbing classes, yoga classes, aerobic classes, and crossfit classes for all levels of fitness. They host in-house 12-step meetings and hold support groups. They host outdoor runs, hikes and rock climbing. They host teams for indoor-volleyball, indoor-soccer, and softball. They host activities to serve the homeless community. The founders of Fit To Recover genuinely care about helping others and are truly providing a unique service to our community. Fit To Recover, thanks for being so awesome!"
	},
	{
	author: 'Steph',
	date: 'December 10, 2016',
	...
	subject: '',
	body: "Fit to Recover's bootcamps for the past 6 months have helped individuals recover from addiction through exercising and promoting a healthy lifestyle, creating a positive outlet and behavior change, showing me how I can now live my life. It offers a safe, inclusive environment that fosters support for those who are recovering. I'm very grateful for all that Fit to Recover has done and continues to offer. It re-introduced me to a passion for exercising, all while meeting incredible, fun people. If you're thinking of joining, join. One of the best decisions I've made in my sobriety. Tullivan, Sober 6+ months"
	},
	{
	author: 'Sandra',
