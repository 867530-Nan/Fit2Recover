...
<div className="footerWide">
			...
			<div className="actualFooter">
				...
				<div className="feedback">
					<a className="bottomMailTo" target="_blank" rel="noopener noreferrer" href="https://www.google.com/maps/place/Fit+to+Recover/@40.7399488,-111.9142314,17z/data=!4m13!1m7!3m6!1s0x8752f4da86d2a85f:0x98c2d4e4a171bc13!2s789+W+1390+S,+Salt+Lake+City,+UT+84104!3b1!8m2!3d40.7392009!4d-111.9137379!3m4!1s0x8752f4da86ddc03f:0x24d4219acbd712ad!8m2!3d40.739265!4d-111.913712">
						789 West 1390 South, Salt Lake City, Utah 84104	
					</a>
				</div>

			  <div className="navCopy">
			  	<div className="footerLinks" as="h3"><a target="_blank" rel="noopener noreferrer" className="footerALinks" href="/">Home</a></div>
			  		<span>|</span>
			  	<div className="footerLinks" as="h3"><a target="_blank" rel="noopener noreferrer" className="footerALinks" href="/fitness">Fitness</a></div>
			  		<span>|</span>
			  	<div className="footerLinks" as="h3"><a target="_blank" rel="noopener noreferrer" className="footerALinks" href="/nutrition">Nutrition</a></div>
			  		<span>|</span>
			  	<div className="footerLinks" as="h3"><a target="_blank" rel="noopener noreferrer" className="footerALinks" href="/creativearts">Creative Arts</a></div>
			  		<span>|</span>
			  	<div className="footerLinks" as="h3"><a target="_blank" rel="noopener noreferrer" className="footerALinks" href="/communityservice">Community Service</a></div>
			  		<span>|</span>
			  	<div className="footerLinks" as="h3"><a target="_blank" rel="noopener noreferrer" className="footerALinks" href="/contact">Contact Us</a></div>
			  </div>
